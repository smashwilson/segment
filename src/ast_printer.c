...
void seg_print_ast(seg_statementlist_node *root, FILE *outf)
{
    ...
    seg_ast_visit_binop(visitor, &print_binop);
    seg_ast_visit_expr(visitor, &print_expr);
    seg_ast_visit_statement(visitor, &print_statement);
    seg_ast_visit_statementlist(visitor, &print_statementlist);
